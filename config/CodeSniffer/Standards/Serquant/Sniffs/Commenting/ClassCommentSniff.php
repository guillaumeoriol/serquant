...
if (class_exists('Serquant_Sniffs_Commenting_FileCommentSniff', true) === false) {
    $error = 'Class Serquant_Sniffs_Commenting_FileCommentSniff not found';
    throw new PHP_CodeSniffer_Exception($error);
}
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Serquant_Sniffs_Commenting_ClassCommentSniff extends Serquant_Sniffs_Commenting_FileCommentSniff
{
