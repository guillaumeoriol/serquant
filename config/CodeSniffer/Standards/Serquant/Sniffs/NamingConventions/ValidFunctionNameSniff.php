<?php
/**
 * Serquant_Sniffs_NamingConventions_ValidFunctionNameSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Serquant_Sniffs_NamingConventions_ValidFunctionNameSniff extends PHP_CodeSniffer_Standards_AbstractScopeSniff
{
    ...
    /**
     * Constructs a Serquant_Sniffs_NamingConventions_ValidFunctionNameSniff.
     */
    ...
    protected function processTokenWithinScope(PHP_CodeSniffer_File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        // If it's a protected or private method, it should not have an
        // underscore on the front.
        if ($isPublic === false && $methodName{0} === '_') {
            $error = 'Protected/private method name "%s" should not be prefixed with an underscore';
            $phpcsFile->addWarning($error, $stackPtr, 'PrivateUnderscore', $errorData);
            return;
        }
