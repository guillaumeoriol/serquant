<?php
/**
 * Serquant_Sniffs_NamingConventions_ValidVariableNameSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Serquant_Sniffs_NamingConventions_ValidVariableNameSniff extends PHP_CodeSniffer_Standards_AbstractVariableSniff
{
    ...
    protected function processMemberVar(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        // If it's a private member, it should not have an underscore on the front.
        if ($isPublic === false && $memberName{0} === '_') {
            $error = 'Private member variable "%s" should not be prefixed with an underscore';
